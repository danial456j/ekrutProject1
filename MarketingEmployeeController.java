...
public class MarketingEmployeeController {
	...
	public void start(Stage primaryStage) throws Exception {	
		Parent root = FXMLLoader.load(getClass().getResource("/clientGUI/MarketingEmployeeForm.fxml"));
	...
	/**
	 * open the Activate discount page
	 * @param event
	 * @throws Exception
	 */
    public void ActivateDsicountPageBTN(ActionEvent event) throws Exception{
    	  ActivateDiscountController aFrame = new ActivateDiscountController();
