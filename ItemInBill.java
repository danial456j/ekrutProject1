...
public class ItemInBill extends Item {
	...
	private String totalPriceWithShekel;
	...
	public ItemInBill(String id, String imageName, String originalPrice, String priceAfterDiscount, String amount, String name, Integer quantityInOrder) {
		...
		//totalPriceWithShekel = Integer.toString(totalPrice) + "₪";
	}
	...
	public String getTotalPriceWithShekel() {
		return totalPriceWithShekel;
	}

	public void setTotalPriceWithShekel(String totalPriceWithShekel) {
		this.totalPriceWithShekel = totalPriceWithShekel;
	}
